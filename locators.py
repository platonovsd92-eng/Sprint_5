...
# Текстовые элементы для конструктора (для проверки)
BUNS_TEXT = (By.XPATH, ".//span[text()='Булки']")  # Текст «Булки»
SAUCES_TEXT = (By.XPATH, ".//span[text()='Соусы']")  # Текст «Соусы»
FILLINGS_TEXT = (By.XPATH, ".//span[text()='Начинки']")  # Текст «Начинки»
